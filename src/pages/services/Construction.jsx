          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  With over <strong className="text-[#006837]">60+ Years of Legacy</strong>, Jyothi Construction has redefined building standards through an integrated approach. By manufacturing our own premium materials, we maintain unmatched control over project quality, costs, and timelines.
                </p>
              ...
              {/* Strategic Stages */}
              <div className="mb-16">
                <h3 className="text-2xl font-bold text-[#006837] mb-8 font-heading">Execution Philosophy</h3>
              ...
              <div className="bg-[#006837] rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
                <div className="md:w-1/2">
                  <Image src="/assets/images/unsplash-34e86d0c.jpg" alt="Construction Site" className="w-full h-full object-cover min-h-[300px]" />
                </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32 space-y-8">
                ...
                {/* Download Brochure */}
                <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8">
                  <h4 className="text-xl font-bold text-[#006837] mb-6 font-heading">Our Portfolio</h4>
