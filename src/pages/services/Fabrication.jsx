...
const Fabrication = () => {
  const offerings = [
    { title: 'Structural Steelwork', icon: <ClipboardList className="w-5 h-5" />, desc: 'Heavy-duty steel fabrication for industrial and warehouse frameworks.' },
    { title: 'Custom Components', icon: <Zap className="w-5 h-5" />, desc: 'Precision engineered metal parts tailored to unique project needs.' },
    { title: 'Welding Excellence', icon: <Microscope className="w-5 h-5" />, desc: 'Certified industrial welding services for structural stability.' },
    { title: 'Site Installation', icon: <Truck className="w-5 h-5" />, desc: 'Seamless on-site assembly and structural integration.' },
    { title: 'Corrosion Protection', icon: <Factory className="w-5 h-5" />, desc: 'Advanced coating and galvanizing for long-lasting durability.' },
    { title: 'Engineering Support', icon: <ShieldCheck className="w-5 h-5" />, desc: 'Technical design and load-bearing analysis for all metal works.' }
  ];
            ...
            <div className="lg:col-span-2">
              <div className="mb-12">
                <h2 className="text-3xl md:text-4xl font-extrabold text-[#006837] mb-6 font-heading">
                  Structural & Customized Metal Solutions
                </h2>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  With over <strong className="text-[#006837]">60+ Years of Legacy</strong>, Jyothi Construction delivers precision fabrication services for a wide range of industrial and residential applications. Our state-of-the-art facility is equipped to handle complex structural steelwork with unmatched accuracy.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  We specialize in building trusses, industrial sheds, customized steel components, and architectural metal features, ensuring that every project meets the highest benchmarks for strength and durability.
                </p>
              </div>
              ...
              {/* Strategic Stages */}
              <div className="mb-16">
                <h3 className="text-2xl font-bold text-[#006837] mb-8 font-heading">Fabrication Lifecycle</h3>
              ...
              <div className="bg-[#006837] rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 p-8 md:p-12">
                  ...
                  <ul className="space-y-4">
                    {[
                      'High-precision industrial welding.',
                      'Corrosion-resistant finishes.',
                      'Certified structural safety.',
                      'Fast-track site installation.'
                    ].map((text, i) => (
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8">
                  <h4 className="text-xl font-bold text-[#006837] mb-6 font-heading">Focus Areas</h4>
                ...
                {/* Download Brochure */}
                <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8">
                  <h4 className="text-xl font-bold text-[#006837] mb-6 font-heading">Capability Deck</h4>
                  <p className="text-sm text-gray-600 mb-6">Download our fabrication portfolio and safety certification documents.</p>
                ...
                <div className="bg-[#002B1B] rounded-2xl p-8 relative overflow-hidden">
                  ...
                  <div className="space-y-6 relative z-10">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 uppercase tracking-widest">Tech Desk</p>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 uppercase tracking-widest">Technical Inquiry</p>
                        <p className="text-lg font-bold text-white">fab@jyothi.com</p>
                      </div>
                    </div>
